            ...
            <div class="owl-carousel owl-simple" data-toggle="owl" data-owl-options='{
                ...
                <article class="entry">
                    <figure class="entry-media">
                        <a href="single.html">
                            <img src="frontend/assets/images/demos/demo-13/blog/post-1.jpg" alt="image desc">
                        </a>
                ...
                <article class="entry">
                    <figure class="entry-media">
                        <a href="single.html">
                            <img src="frontend/assets/images/demos/demo-13/blog/post-2.jpg" alt="image desc">
                        </a>
                    </figure><!-- End .entry-media -->
                ...
                <article class="entry">
                    <figure class="entry-media">
                        <a href="single.html">
                            <img src="frontend/assets/images/demos/demo-13/blog/post-3.jpg" alt="image desc">
                        </a>
                    </figure><!-- End .entry-media -->
                ...
                <article class="entry">
                    <figure class="entry-media">
                        <a href="single.html">
                            <img src="frontend/assets/images/demos/demo-13/blog/post-4.jpg" alt="image desc">
                        </a>
                    </figure><!-- End .entry-media -->
...
<footer class="footer footer-2">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-lg-6">
                            <div class="widget widget-about">
                                <img src="frontend/assets/images/demos/demo-13/logo-footer.png" class="footer-logo" alt="Footer Logo" width="105" height="25">
    ...
    <script src="frontend/assets/js/demos/demo-13.js"></script>
</body>
