...
<head>
    ...
    <link rel="apple-touch-icon" href="zay/img/apple-icon.png">
    <link rel="shortcut icon" type="image/x-icon" href="zay/img/favicon.ico">

    <link rel="stylesheet" href="zay/css/bootstrap.min.css">
